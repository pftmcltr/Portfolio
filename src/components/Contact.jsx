...
const Contact = () => {
  ...
  return (
    <div id="bottom" className="bg-orange-dark pb-10 pt-24">
      {/* Title */}
      <div className="px-5 mb-10 text-5xl sm:text-6xl md:text-7xl text-center md:text-left text-orange-dark max-w-6xl mx-auto font-black">
        <p className="outlined">Do you need</p>
        <p className="text-white ">my expertise?</p>
      </div>

      <div className="flex md:pt-5 flex-1 flex-wrap flex-shrink justify-center items-center">
        <img
          src={bullWarning}
          alt="bull warning sign"
          className="w-80 bull-warning-animation hidden lg:block z-20"
        />
        <div className="lg:-ml-32 md:m-10 md:p-20 md:border-2 bg-orange-dark  border-orange border-dashed flex flex-col justify-center items-center gap-10 md:max-w-2xl ">
          <p className="text-xl px-10 md:px-0 font-medium text-orange-light text-center">
