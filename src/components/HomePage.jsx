...
const HomePage = () => {
  return (
    ...
    >
      ...
      <div className="flex p-5 gap-8 md:gap-18 lg:gap-20 flex-col justify-start sm:justify-center items-center text-center md:h-screen">
        <div className="h-52 sm:h-96 md:hidden"></div>
        <p className="text-7xl main-title text-white md:max-w-xl lg:max-w-3xl leading-tight">
          Let me take the bull by the horns.
        </p>
        <p className="max-w-md md:max-w-xs lg:max-w-md text-2xl font-semibold main-subtitle text-red-dark">
